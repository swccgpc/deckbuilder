...
export const CardResolver = {
  ...
  hyperspeed: (_parent) => _parent.front.hyperspeed,
  defense: (_parent) => _parent.front.defense,
  ability: (_parent) => _parent.front.ability,
  armor: (_parent) => _parent.front.armor,
  landspeed: (_parent) => _parent.front.landspeed,
  maneuver: (_parent) => _parent.front.maneuver,
